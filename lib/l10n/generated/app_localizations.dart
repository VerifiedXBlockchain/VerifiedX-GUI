...
abstract class AppLocalizations {
  ...
  /// No description provided for @bw2BeaconUploadFailedHasMedia.
  ///
  /// In en, this message translates to:
  /// **'Beacon upload failed. This token has a media file that must be transferred with it, so the transfer cannot continue until a beacon is reachable.'**
  String get bw2BeaconUploadFailedHasMedia;
  ...
  /// No description provided for @bw2BtcSentTapToSettle.
  ///
  /// In en, this message translates to:
  /// **'BTC sent — tap to finish settling on VFX'**
  String get bw2BtcSentTapToSettle;
  ...
  /// No description provided for @bw2CheckingWithdrawalStatus.
  ///
  /// In en, this message translates to:
  /// **'Checking Withdrawal Status'**
  String get bw2CheckingWithdrawalStatus;

  /// No description provided for @bw2CompletionPendingHint.
  ///
  /// In en, this message translates to:
  /// **'Retry below to finish. This only submits the completion transaction — your Bitcoin will not be sent again. You can also come back to this from the token\'s withdrawal history.'**
  String get bw2CompletionPendingHint;

  /// No description provided for @bw2CompletionPendingHintUnsaved.
  ///
  /// In en, this message translates to:
  /// **'Retry below to finish. This only submits the completion transaction — your Bitcoin will not be sent again. This withdrawal could not be saved for later recovery, so do not close this page before it succeeds. Copy the Bitcoin transaction ID below first.'**
  String get bw2CompletionPendingHintUnsaved;

  /// No description provided for @bw2CompletionPendingTitle.
  ///
  /// In en, this message translates to:
  /// **'Your Bitcoin was sent, but the withdrawal has not been settled on the VFX chain yet.'**
  String get bw2CompletionPendingTitle;

  /// No description provided for @bw2CompletionUnknownBtcTx.
  ///
  /// In en, this message translates to:
  /// **'Could not determine the Bitcoin transaction for this withdrawal, so it cannot be settled automatically. Check the destination address on a block explorer and contact support before retrying — retrying may broadcast a second Bitcoin transaction.'**
  String get bw2CompletionUnknownBtcTx;
  ...
  /// No description provided for @bw2RecordingCompletion.
  ///
  /// In en, this message translates to:
  /// **'Recording completion on the VFX chain...'**
  String get bw2RecordingCompletion;

  /// No description provided for @bw2RecordingCompletionHint.
  ///
  /// In en, this message translates to:
  /// **'The Bitcoin transaction has been broadcast. This final transaction settles the withdrawal on chain.'**
  String get bw2RecordingCompletionHint;

  /// No description provided for @bw2RecordingCompletionTitle.
  ///
  /// In en, this message translates to:
  /// **'Recording Completion'**
  String get bw2RecordingCompletionTitle;
  ...
  /// No description provided for @bw2RetryCompletion.
  ///
  /// In en, this message translates to:
  /// **'Retry Completion'**
  String get bw2RetryCompletion;
  ...
  /// No description provided for @r3cTypeValidatorExit.
  ///
  /// In en, this message translates to:
  /// **'Validator Exit'**
  String get r3cTypeValidatorExit;
  ...
  /// No description provided for @r3cTypeVbtcBridgeExitToBtc.
  ///
  /// In en, this message translates to:
  /// **'vBTC Bridge Exit to BTC'**
  String get r3cTypeVbtcBridgeExitToBtc;

  /// No description provided for @r3cTypeVbtcBridgeExitToBtcComplete.
  ///
  /// In en, this message translates to:
  /// **'vBTC Bridge Exit to BTC Complete'**
  String get r3cTypeVbtcBridgeExitToBtcComplete;

  /// No description provided for @r3cTypeVbtcBridgeExitToBtcFailed.
  ///
  /// In en, this message translates to:
  /// **'vBTC Bridge Exit to BTC Failed'**
  String get r3cTypeVbtcBridgeExitToBtcFailed;
  ...
  /// No description provided for @r3cTypeVbtcBridgePoolUnlock.
  ///
  /// In en, this message translates to:
  /// **'vBTC Bridge Pool Unlock'**
  String get r3cTypeVbtcBridgePoolUnlock;
