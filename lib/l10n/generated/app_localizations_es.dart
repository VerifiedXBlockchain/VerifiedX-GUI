...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String btcBulkInsufficientCombined(String available, String requested) {
    return 'Saldo combinado de vBTC insuficiente. Disponible: $available vBTC, solicitado: $requested vBTC.';
  }

  @override
  String btcBulkTooManyInputs(String max) {
    return 'Este monto necesitaría más de $max tokens en una sola transacción. Envía un monto menor.';
  }
  ...
  @override
  String get bw2BeaconUploadFailedHasMedia => 'Fallo la subida al beacon. Este token tiene un archivo multimedia que debe transferirse con el, por lo que la transferencia no puede continuar hasta que haya un beacon disponible.';
  ...
  @override
  String get bw2BtcSentTapToSettle => 'BTC enviado: toca para terminar de liquidar en VFX';
  ...
  @override
  String get bw2CheckingWithdrawalStatus => 'Comprobando el estado del retiro';

  @override
  String get bw2CompletionPendingHint => 'Reintenta abajo para terminar. Esto solo envia la transaccion de finalizacion: tu Bitcoin no se enviara de nuevo. Tambien puedes volver a esto desde el historial de retiros del token.';

  @override
  String get bw2CompletionPendingHintUnsaved => 'Reintenta abajo para terminar. Esto solo envia la transaccion de finalizacion: tu Bitcoin no se enviara de nuevo. Este retiro no se pudo guardar para recuperarlo mas tarde, asi que no cierres esta pagina hasta que tenga exito. Copia primero el ID de la transaccion de Bitcoin.';

  @override
  String get bw2CompletionPendingTitle => 'Tu Bitcoin fue enviado, pero el retiro aun no se ha liquidado en la cadena VFX.';

  @override
  String get bw2CompletionUnknownBtcTx => 'No se pudo determinar la transaccion de Bitcoin de este retiro, por lo que no puede liquidarse automaticamente. Revisa la direccion de destino en un explorador de bloques y contacta con soporte antes de reintentar: reintentar puede transmitir una segunda transaccion de Bitcoin.';
  ...
  @override
  String get bw2RecordingCompletion => 'Registrando la finalizacion en la cadena VFX...';

  @override
  String get bw2RecordingCompletionHint => 'La transaccion de Bitcoin ya fue transmitida. Esta transaccion final liquida el retiro en la cadena.';

  @override
  String get bw2RecordingCompletionTitle => 'Registrando la finalizacion';
  ...
  @override
  String get bw2RetryCompletion => 'Reintentar finalizacion';
  ...
  @override
  String get bw2VerifyingWithdrawalBody => 'La solicitud agoto el tiempo de espera. Comprobando si el retiro se completo de todos modos...';

  @override
  String get bw2VerifyingWithdrawalHint => 'La firma puede durar mas que la solicitud. Espera en lugar de reintentar: reintentar puede transmitir una segunda transaccion de Bitcoin.';
  ...
  @override
  String get chainRebuildBannerTitle => 'Reconstruyendo el estado de la cadena';

  @override
  String get chainRebuildBannerBody => 'VFXCore está verificando de nuevo su copia del libro mayor. Los saldos se muestran en cero hasta que termine, lo que puede tardar varios minutos. Mantén la billetera abierta.';

  @override
  String get chainRebuildBalancePlaceholder => 'Reconstruyendo…';
  ...
  @override
  String get r3cTypeValidatorExit => 'Salida de validador';
  ...
  @override
  String get r3cTypeVbtcBridgeExitToBtc => 'Salida del puente vBTC a BTC';

  @override
  String get r3cTypeVbtcBridgeExitToBtcComplete => 'Salida del puente vBTC a BTC completada';

  @override
  String get r3cTypeVbtcBridgeExitToBtcFailed => 'Salida del puente vBTC a BTC fallida';

  @override
  String get r3cTypeVbtcBridgeLock => 'Bloqueo puente vBTC';

  @override
  String get r3cTypeVbtcBridgePoolUnlock => 'Desbloqueo del pool del puente vBTC';
  ...
  @override
  String get r3hVbtcPrivacyRecipientInvalid => 'vBTC solo puede enviarse a una dirección VFX estándar (no a una dirección de privacidad).';

  @override
  String get r3hVbtcVaultRecipientInvalid => 'vBTC solo puede enviarse a una dirección VFX estándar (no a una cuenta Vault).';
  ...
  String tkbPendingWithdrawalBody(String amount, String destination) {
    return 'Este token tiene un retiro pendiente de $amount vBTC a $destination.\n\nPuede haberlo solicitado otro titular de este token. Solo la cuenta que lo solicito puede completarlo.\n\n¿Quieres intentar completarlo?';
  }
