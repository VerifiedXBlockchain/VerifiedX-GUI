...
import '../providers/web_tokenized_btc_onboard_provider.dart';
...
part './web_tokenize_btc_onboarding_steps.dart';

class WebTokenizeBtcOnboardingScreen extends BaseScreen {
  const WebTokenizeBtcOnboardingScreen({super.key});
                  ...
                  builder: (context) {
                    switch (state.step) {
                      ...
                      case VBtcOnboardStep.transferBtcToVbtc:
                        return _WebTransferBtcToVbtcStep();
                    }
                  },
                ),
              Builder(
